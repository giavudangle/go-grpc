...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=giavudangle.grpc.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x67, 0x6c, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x22, 0xb1, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x67, 0x69, 0x61, 0x76, 0x75, 0x64,
	0x61, 0x6e, 0x67, 0x6c, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x0a, 0x08, 0x54, 0x45, 0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x22, 0x0a, 0x18,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: giavudangle.grpc.Memory.Unit
	(*Memory)(nil),   // 1: giavudangle.grpc.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: giavudangle.grpc.Memory.unit:type_name -> giavudangle.grpc.Memory.Unit
