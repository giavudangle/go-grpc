...
type Filter struct {
	...
	MinCpuCores float64 `protobuf:"fixed64,2,opt,name=min_cpu_cores,json=minCpuCores,proto3" json:"min_cpu_cores,omitempty"`
...
func (x *Filter) GetMinCpuCores() float64 {
	if x != nil {
...
var file_filter_message_proto_rawDesc = []byte{
	...
	0x67, 0x6c, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x6d, 0x69, 0x6e, 0x43, 0x70, 0x75, 0x43, 0x6f, 0x72, 0x65,
	...
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x67, 0x69, 0x61, 0x76, 0x75, 0x64, 0x61, 0x6e, 0x67, 0x6c, 0x65,
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x69,
	0x6e, 0x52, 0x61, 0x6d, 0x42, 0x22, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x61, 0x76,
...
var file_filter_message_proto_goTypes = []interface{}{
	(*Filter)(nil), // 0: giavudangle.grpc.Filter
	(*Memory)(nil), // 1: giavudangle.grpc.Memory
}
var file_filter_message_proto_depIdxs = []int32{
	1, // 0: giavudangle.grpc.Filter.min_ram:type_name -> giavudangle.grpc.Memory
